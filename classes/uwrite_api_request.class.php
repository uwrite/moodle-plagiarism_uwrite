...
use plagiarism_uwrite\library\OAuth\OAuthConsumer;
use plagiarism_uwrite\library\OAuth\OAuthRequest;
use plagiarism_uwrite\library\OAuth\Signature\OAuthSignatureMethod_HMAC_SHA1;
...
/**
 * Class uwrite_api_request
 *
 * @package plagiarism_uwrite\classes
 */
class uwrite_api_request {
    /**
     * @var null|uwrite_api_request
     */
    ...
    final public static function instance() {
        return isset(self::$instance) ? self::$instance : self::$instance = new uwrite_api_request();
    }
    ...
    private function gen_oauth_headers() {
        ...
        $oauthconsumer = new OAuthConsumer(uwrite_settings::get_settings('client_id'), uwrite_settings::get_settings('api_secret'));
