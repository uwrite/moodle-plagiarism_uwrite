...
/**
 * reset.php - resets an uwrite submission
 *
...
require_capability('plagiarism/uwrite:resetfile', $modulecontext);

uwrite_core::resubmit_file($pf);
...
redirect($redirect, plagiarism_uwrite::trans('filereset'));